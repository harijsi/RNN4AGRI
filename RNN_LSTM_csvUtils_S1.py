...
parser.add_argument('-sequence_name', default=f'RNN_LSTM_CSV_S1_temp_feat_3class', type=str)
...
def target_to_oh(target):
    num_class = num_of_classes  # hard code here, can do partial
...
train_dataset, test_dataset = torch.utils.data.random_split(DatasetTabular(is_train=True, sequence_len=args.sequence_len),
...
# model = ModelRNN(input_size, hidden_size=args.hidden_size, output_size=2)
